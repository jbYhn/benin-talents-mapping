...
function TalentDetail({ t, onClose }) {
  ...
  return (
    <div style={{ padding: "0 16px 24px" }}>
      ...
      {t.linkedin && (
        <a href={t.linkedin} target="_blank" rel="noopener noreferrer" style={{
          display: "flex", alignItems: "center", gap: 7, background: "#0a66c2", color: "#fff",
          borderRadius: 8, padding: "11px 14px", textDecoration: "none", fontSize: 13, fontWeight: 600,
...
export default function DiasporaMap() {
  ...
  useEffect(() => {
    ...
    const t = d3.zoomIdentity.translate(-465.75, -342.11).scale(2.8);
